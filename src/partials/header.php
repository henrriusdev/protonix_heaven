...
<body>
  <header class="sticky top-0 z-50 flex items-center justify-between whitespace-nowrap border-b border-gray-200/50 dark:border-gray-700/50 bg-background-light/80 dark:bg-background-dark/80 backdrop-blur-sm px-10 py-3">
    <div class="flex items-center gap-4">
      ...
      <h2 class="text-lg font-bold">Tech Haven</h2>
    </div>
    <div class="flex flex-1 justify-end gap-6">
      <nav class="hidden md:flex items-center gap-8">
        ...
        <a class="text-sm font-medium hover:text-primary transition-colors" href="/about">Support</a>
        <a class="text-sm font-medium hover:text-primary transition-colors" href="/login">Login</a>
      </nav>
      <div class="flex items-center gap-2">
        <button class="flex items-center justify-center rounded-full h-10 w-10 bg-gray-200/60 dark:bg-gray-700/60 hover:bg-gray-300/60 dark:hover:bg-gray-600/60 transition-colors">
